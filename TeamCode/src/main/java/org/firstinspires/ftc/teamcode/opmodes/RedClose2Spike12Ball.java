...
public class RedClose2Spike12Ball extends BaseAuto {
    @Override
    ...
    protected void setActionList() {
        ...
        PathChain leverToShoot = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(127, 67.000),
        ...
        addAction(
                ...
                new ChangeStateAction(RobotState.SPEED_UP),
                new FollowAction(leverToShoot, () -> follower.getPose().getX() < 96.5),
                new SleepAction(1000),
                new ChangeStateAction(RobotState.FIRE),
                new SleepAction(1000),
                new ChangeStateAction(RobotState.IDLE),
