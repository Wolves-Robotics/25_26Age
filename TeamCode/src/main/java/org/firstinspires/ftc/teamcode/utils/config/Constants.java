...
public class Constants {
    ...
    public static final Pose RED_RESET_POS   = new Pose(96  , 136.91339, Math.toRadians(270));
    ...
    public static final Vector2d RED_TARGET_POS =  new Vector2d(140, 139);
    public static final Vector2d BLUE_TARGET_POS = new Vector2d(8 , 135);
}
